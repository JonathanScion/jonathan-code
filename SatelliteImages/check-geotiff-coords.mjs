 ...
 * Usage: node check-geotiff-coords.mjs <path-to-tiff-file>
 */
...
if (process.argv.length < 3) {
  console.log('Usage: node check-geotiff-coords.mjs <path-to-tiff-file>');
  console.log('\nExample:');
  console.log('  node check-geotiff-coords.mjs C:\\path\\to\\cyprus.tif');
  console.log('  node check-geotiff-coords.mjs "C:\\path with spaces\\image.tif"');
  process.exit(1);
}
