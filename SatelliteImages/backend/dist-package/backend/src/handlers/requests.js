        ...
        let filteredItems = items.filter((item) => {
            ...
            if (filters.query) {
                ...
                const searchableText = [
                    ...
                    item.targetBounds?.north?.toString(),
                    item.targetBounds?.south?.toString(),
                    item.targetBounds?.east?.toString(),
                    item.targetBounds?.west?.toString(),
                    item.requestedStartDate,
                    item.requestedEndDate,
                    item.scheduledDate,
                    item.completedDate,
                    item.minResolution?.toString(),
                    item.maxCloudCoverage?.toString(),
                    item.preferredSatellites?.join(' '),
