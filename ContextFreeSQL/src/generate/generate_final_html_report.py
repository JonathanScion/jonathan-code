...
def generate_html_report(db_type: DBType, sql_buffer, input_output: InputOutput, include_security: bool = True, source_db_label: str = "", include_coded: bool = True):
    ...
    if db_type == DBType.PostgreSQL:
        ...
        # The coded entities state table is only created when coded entities are in scope
        if include_coded:
            sql_buffer.write("\t\t\tUNION ALL\n")
        ...
        # Security state tables only exist when script_security is on
        if include_security:
            sql_buffer.write("\t\t\tUNION ALL\n")
