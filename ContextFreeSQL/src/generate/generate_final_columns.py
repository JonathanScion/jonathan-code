...
def generate_add_alter_drop_cols(db_type: DBType, sql_buffer, j2_alter_cols_not_null, got_data: bool = False):
    ...
    if db_type == DBType.MSSQL:
        ...
        utils.add_exec_sql(db_type, 3, sql_buffer, "temprow.SQL_ALTER")
        ...
        utils.add_exec_sql(db_type, 5, sql_buffer, "'ALTER TABLE ' || temprow.table_schema || '.' || temprow.table_name || ' ALTER COLUMN ' || temprow.col_name || ' ADD GENERATED ALWAYS AS IDENTITY'")
        ...
        utils.add_exec_sql(db_type, 5, sql_buffer, "'ALTER TABLE ' || temprow.table_schema || '.' || temprow.table_name || ' ALTER COLUMN ' || temprow.col_name || ' DROP IDENTITY IF EXISTS'")
    ...
    if db_type == DBType.MSSQL:
        ...
        utils.add_exec_sql(db_type, 3, sql_buffer, "temprow.SQL_DROP")
        sql_buffer.write("\t\tEND LOOP;\n")
        sql_buffer.write("\tEND; --of cursor\n")
    ...
    if got_data:  
        ...
        if db_type == DBType.MSSQL:
            ...
            utils.add_exec_sql(db_type, 3, j2_alter_cols_not_null, "temprow.SQL_ALTER_PostData_NotNULL")
...
def generate_drop_add_defaults(db_type: DBType, j2_defaults_drop, j2_defaults_add):
    ...
    if db_type == DBType.MSSQL:
        ...
        utils.add_exec_sql(db_type, 3, j2_defaults_add)
