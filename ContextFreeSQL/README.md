...
| Variable | Use |
|---|---|
| `CFS_VERSION` | Install a specific release, e.g. `CFS_VERSION=v0.6.1` |
...
| `--help` | `-h` | Show help |
| `--version` | `-v` | Show the version, e.g. `contextfreesql 0.6.1` |
...
```sql
--Generated by ContextFreeSQL 0.6.1 on 2026-09-17 13:12:34 from localhost.const1
```
