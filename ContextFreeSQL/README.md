...
config (such as `./output/...`) are resolved from where you run it.
...
| `--help` | `-h` | Show help |
| `--version` | `-v` | Show the version, e.g. `contextfreesql 0.3.0` |
...
```sql
--Generated by ContextFreeSQL 0.3.0 on 2026-09-17 13:12:34 from localhost.const1
```
