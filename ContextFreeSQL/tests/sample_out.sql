...
');
		...
		VALUES ('public','studentgrades','fk_studentgrades_students','public','students',NULL,NULL,NULL,NULL,NULL,'ALTER TABLE public.studentgrades ADD CONSTRAINT fk_studentgrades_students FOREIGN KEY
(
studentid
)
